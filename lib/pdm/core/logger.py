...
class InfoLoggerV2():
    ...
    """
    def __init__(self, rank, phase, root):
        self.rank = rank
        self.phase = phase
        self.setup_logger(None, root, phase, level=logging.INFO, screen=False)
...
class VisualWriterV2():
    ...
    """
    def __init__(self, rank, log_dir, result_dir, enabled, logger):
        self.rank = rank
        self.writer = None
